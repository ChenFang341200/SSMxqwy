...
<form name="info" id="info" action="Admin_listRooms.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
             房屋号：
      <input type="text" id="room_no" name="room_no" value="${paramsRoom.room_no}" class="inputstyle" style="width:100px"/>&nbsp;
            状态：
      <select id="room_flag" name="room_flag" class="selectstyle" Style="width:100px;">
